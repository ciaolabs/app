...
export default async function HomePage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-[1440px] flex-col px-6 pt-0 sm:px-10 lg:px-12">
      <SiteTopNav
      ...
      <section
        className="relative mt-6 overflow-hidden rounded-[1.5rem] border border-[var(--line-strong)] px-4 py-10 shadow-[var(--shadow-soft)] sm:px-8 sm:py-14 lg:px-10 lg:py-16"
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              {isSignedIn ? (
                <Link
                  href={SURVEYS_ROUTE}
                  className="clay-button-hover inline-flex h-12 items-center gap-2 rounded-full border border-black bg-[var(--accent-blue)] px-6 text-sm font-semibold text-[var(--selected-contrast)] shadow-[var(--shadow-soft)]"
                >
                  Open your surveys
                </Link>
              ) : (
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="clay-button-hover inline-flex h-12 items-center gap-2 rounded-full border border-[var(--line-strong)] bg-[var(--surface-panel-strong)] px-6 text-sm font-semibold text-[var(--ink)] shadow-[var(--shadow-soft)]"
              >
