...
import SurveysLoading from "@/app/(survey)/surveys/loading";
import PersonalitySurveyLoading from "@/app/(survey)/surveys/personality/loading";
import ValuesBeliefsSurveyLoading from "@/app/(survey)/surveys/values-beliefs/loading";
