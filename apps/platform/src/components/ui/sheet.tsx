  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-(--surface-panel-strong) p-6 text-(--ink) shadow-lg transition ease-in-out",
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute top-4 right-4 rounded-md opacity-70 transition hover:opacity-100">
