...
export const MODEL_OPTIONS = [
  { value: "gemini-2.5-flash", label: "Gemini 2.5 Flash", provider: "google" as ApiKeyProvider },
  { value: "gemini-2.5-pro", label: "Gemini 2.5 Pro", provider: "google" as ApiKeyProvider },
