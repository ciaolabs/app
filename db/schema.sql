...
values
  ('personality', 'Measures of Your Personality'),
  ('values-beliefs', 'Personal Values and Beliefs')
on conflict (slug) do update
set title = excluded.title;

insert into research.survey_versions (survey_id, version, scoring_version, status, published_at)
select id, '2026-04-30', '2026-04-30', 'published', now()
from research.surveys
where slug in ('personality', 'values-beliefs')
